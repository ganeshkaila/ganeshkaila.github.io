const r=[{slug:"welcome-template",title:"Welcome — Google Cloud docs–inspired template",date:"2026-03-28",excerpt:"How this static blog is structured, and how to add posts without a database.",body:`
      <p>
    ...
    `},{slug:"gcp-k8s-notes",title:"Notes from the field: GCP, Kubernetes, and reliability",date:"2026-02-10",excerpt:"Short placeholder article — swap in your own thoughts on platform work, incidents, or architecture.",body:`
      <p>
    ...
    `}];function n(o){if(o)return r.find(e=>e.slug===o)}function s(){return"/"}function i(o){const e=s(),t=new Date().getFullYear(),a=o.active==="blog"?' aria-current="page"':"";return`
  <a class="skip blog-skip" href="#main">Skip to content</a>
  <header class="blog-topbar">
    <div class="blog-topbar__inner">
      <a class="blog-topbar__brand" href="${e}">Ganesh Kaila</a>
      <nav class="blog-topbar__nav" aria-label="Primary">
        <a href="${e}#about">About</a>
        <a href="${e}#experience">Experience</a>
        <a href="${e}#credentials">Credentials</a>
        <a href="${e}blog/"${a}>Blog</a>
        <a href="${e}#connect">Connect</a>
      </nav>
    </div>
  </header>
  <main id="main" class="blog-main">${o.mainInner}</main>
  <footer class="blog-footer">
    <div class="blog-footer__inner">
      <p>© ${t} Ganesh Kaila · <a href="${e}">Home</a></p>
    </div>
  </footer>
`}function l(o){return o.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function c(o){return new Date(o+"T12:00:00").toLocaleDateString("en-IN",{year:"numeric",month:"long",day:"numeric"})}export{l as e,c as f,n as g,r as p,i as r,s};
