  ...
  <main id="main">
    <section class="wrap hero" aria-labelledby="hero-heading">
      ...
      <p class="hero__lede">
        ...
        <strong>DevOps</strong>. I work at <strong>Google Business Line, Insight</strong>, helping teams design and operate reliable platforms.
        Based in <strong>Hyderabad, India</strong>.
      </p>
    </section>
        ...
        <ol class="exp-list">
          <li class="exp-item">
            <div class="exp-item__header">
              <h3 class="exp-item__title">Enterprise Cloud Architect, Google Business Line</h3>
              <p class="exp-item__meta">
                <span class="exp-item__company">Insight</span>
                <span class="exp-item__dates" aria-label="Employment dates">Jan 2026 – Present</span>
              </p>
            </div>
          ...
          <li class="exp-item">
            <div class="exp-item__header">
              ...
              <p class="exp-item__meta">
                ...
                <span class="exp-item__dates">May 2024 – Jan 2026</span>
              </p>
            </div>
          </li>
          <li class="exp-item">
